...
# 2. Find all rows containing any DOI
# regex=True is the default for str.contains
...
for doi in external_doi_list:
    # Perform a contains search for a single DOI
...
# %%
# 3. Use boolean inversion (~) to find rows that do not contain any DOI
df = df[~mask_contains].copy() # Use .copy() to avoid SettingWithCopyWarning
df
